...
if ($row == 0) {
  ...
  while ($data1 = mysql_fetch_array($res1)) {
    ...
    $content .= "<table id='myTable' class='table' width='100%' style='margin:0px; margin-top:-1px; overflow: wrap;'>
                <thead>
                  <tr>
                    <td colspan='10' style='text-align:left;'><b>".$no.". Kode Barang : ".$dpukdbrg." - ".$dpunmbrg."</b></td>
                  </tr>
                  <tr>
                    <th style='width: 8%;'>No. MP</th>
                    <th style='width: 12%;'>Sub Pekerjaan</th>
    ...
    while ($data2 = mysql_fetch_array($res2)) {
      ...
      $xcontent .= "<tr>
                    ...
                    <td style='text-align:left; width: 12%;'>".$nmsubpkj."</td>
                    <td style='text-align:left; width: 12%;'>".$nmcust."</td>
                    <td style='text-align:left; width: 12%;'>".$article."</td>
                    <td style='text-align:left; width: 14%;'>".$last."</td>
                    <td style='text-align:left; width: 14%;'>".$colour."</td>
                    <td style='text-align:right; width: 7%;'>".(float) $tot."</td>
                    <td style='text-align:right; width: 7%;'>".(float) $qty."</td>
                    <td style='width: 7%;'>".$nstn."</td>
                    <td style='text-align:right; width: 7%;'>".(float) $sisa."</td>
                  </tr>";
    ...
    if ($totsisa > 0) {
      $content .= $xcontent;
      $content .= "<tr>
                  <td colspan='8'><b>Total Qty. Outstanding</b></td>
                  <td colspan='2'><b>".(float) $totsisa."</b></td>
                </tr>";
    }
